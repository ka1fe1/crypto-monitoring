...
*   **tag**
    ```bash
    docker tag crypto-monitoring:2602281003 tataka1takes2/crypto-monitoring:2602281003
    ```

*   **推送**
    ```bash
    docker push tataka1takes2/crypto-monitoring:2602281003
    ```

*   **拉取**
    ```bash
    docker pull tataka1takes2/crypto-monitoring:2602281003
    ```
