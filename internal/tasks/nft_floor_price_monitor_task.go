...
func NewNFTFloorPriceMonitorTask(openSeaService service.OpenSeaService, dingBot *dingding.DingBot, collections []string, intervalSeconds int) *NFTFloorPriceMonitorTask {
